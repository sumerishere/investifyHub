...
//     async function fun() {
//       try {
//         // First, fetch the invested startups
...
//           const errorDetails = await startupsResponse.text();
//           throw new Error(`Failed to submit startups data, try again. Details: ${errorDetails}`);
//         }

//         const startupsData = await startupsResponse.json();

//         // Second, fetch the investor info with username and password as query parameters
//         const investorResponse = await fetch(`http://localhost:8080/get-investor?username=${encodeURIComponent(username)}&password=${encodeURIComponent(password)}`, {
//           method: "GET",
//           headers: {
//             "Content-Type": "application/json",
//           },
...
//           const errorDetails = await investorResponse.text();
//           throw new Error(`Failed to fetch investor info, try again. Details: ${errorDetails}`);
//         }
...
//             Don't have an account? Or with
//             <span className="span-sign-up">
//               <Link to="/InvestorSignUp" style={{ textDecoration: "none", color: "#317efb" }}>
//                 Sign-Up
//               </Link>
//             </span>
//           </p>
